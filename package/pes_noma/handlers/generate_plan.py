...
- Request mentions "book for John and Alice" → ["John", "Alice"]
- Request mentions no names → []

Rules:
- Return [] if no person is explicitly named in the request.
- Never invent or assume names. Only include names that literally appear in the text.
